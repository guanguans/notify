 ...
 * @method \Guanguans\Notify\Foundation\Client cookies(false|\GuzzleHttp\Cookie\CookieJarInterface $cookies)
 * @method \Guanguans\Notify\Foundation\Client cryptoMethod(int $cryptoMethod)
 * @method \Guanguans\Notify\Foundation\Client cryptoMethodMax(int $cryptoMethodMax)
 ...
 * @method \Guanguans\Notify\Foundation\Client decodeContent(bool|string $decodeContent)
 * @method \Guanguans\Notify\Foundation\Client delay(float|int $delay)
 * @method \Guanguans\Notify\Foundation\Client expect(bool|integer $expect)
 * @method \Guanguans\Notify\Foundation\Client forceIpResolve(string $forceIpResolve)
 * @method \Guanguans\Notify\Foundation\Client formParams(array<int|string, null|array|bool|float|int|string> $formParams)
 * @method \Guanguans\Notify\Foundation\Client headers(null|array<int|string, array<int|string, string>|string> $headers)
 * @method \Guanguans\Notify\Foundation\Client httpErrors(bool $httpErrors)
 * @method \Guanguans\Notify\Foundation\Client idnConversion(null|bool|int $idnConversion)
 ...
 * @method \Guanguans\Notify\Foundation\Client multiplex(string $multiplex)
 ...
 * @method \Guanguans\Notify\Foundation\Client onTrailers(callable $onTrailers)
 * @method \Guanguans\Notify\Foundation\Client progress(callable $progress)
 * @method \Guanguans\Notify\Foundation\Client protocols(array<int|string, string> $protocols)
