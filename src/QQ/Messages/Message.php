        ...
        return [
            ...
            'ark' => static function (OptionsResolver $optionsResolver): void {
                $optionsResolver
                    ...
                    ->setOptions('kv', static function (OptionsResolver $optionsResolver): void {
                        $optionsResolver
                            ->setPrototype(true)
                            ->setDefined([
                                'key',
                            ...
                            ->setOptions('obj', static function (OptionsResolver $optionsResolver): void {
                                $optionsResolver
                                    ->setPrototype(true)
                                    ->setDefined([
                                        'obj_kv',
                                    ...
                                    ->setOptions('obj_kv', static function (OptionsResolver $optionsResolver): void {
                                        $optionsResolver
                                            ->setPrototype(true)
                                            ->setDefined([
                                                'key',
            ...
            'markdown' => static function (OptionsResolver $optionsResolver): void {
                $optionsResolver
                    ...
                    ->setOptions('params', static function (OptionsResolver $optionsResolver): void {
                        $optionsResolver
                            ->setDefined([
                                'key',
                                'values',
